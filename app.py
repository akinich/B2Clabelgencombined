...
def draw_label_pdf(c, order_no, customer_name, font_name, width, height, font_override=0):
    ...
    if len(words) == 2:
        ...
        # Compute each word's max font size independently
...
st.write("Labels with Order No on top (#prefix) and Customer Name below. Two-word names scale independently to maximize font size. Minimum spacing ensures visual balance.")
